      ...
      onSlideChange={() => console.log('slide change')}> */}
            ...
            >
                <SwiperSlide>
                    ...
                    <NavLink to={"/shop"}>
                        <img src="https://cdn.shopify.com/s/files/1/0057/8938/4802/files/Desktop-Apex_1400x.jpg?v=1676011122" alt="" />
                    </NavLink>
                ...
                <SwiperSlide>
                    <NavLink to={"/shop"}>
                        ...
                        <img src="https://cdn.shopify.com/s/files/1/0057/8938/4802/files/love-out-loud_desktop.-2-2_1b631be8-dfae-4e8b-a6d2-06a9677564a8_1400x.jpg?v=1676004171" alt="" />
                    </NavLink>
                </SwiperSlide>
                <SwiperSlide>
                    <NavLink to={"/shop"}>

                        <img src="https://cdn.shopify.com/s/files/1/0057/8938/4802/files/Desktop-192_1400x.jpg?v=1676266993" alt="" />
                    </NavLink>
                        ...
                        <div className="row mb-n6">
                            ...
                            <div className="col-lg-6 col-12 mb-6">
                                ...
                                <div className="banner-single-item banner-style-1 banner-animation img-responsive"
                                    ...
                                    <div className="image">
                                        <img src="https://cdn.shopify.com/s/files/1/0548/8849/7221/files/Wireless_0a5abbc3-346c-40f8-9882-cfb2fe62b667_400x.png?v=1672254777" alt="" style={{ height: "500px" }} />
                                    </div>
                                    <div className="content">
                                ...
                                <div className="row mb-n6">
                                    ...
                                    <div className="col-lg-6 col-sm-6 mb-6">
                                        <div className="banner-single-item banner-style-2 banner-animation img-responsive"
                                            ...
                                            <div className="image">
                                                <img src="https://cdn.shopify.com/s/files/1/0548/8849/7221/files/Frame_52_533x.png?v=1675175865" alt="" style={{ borderRadius: "10%" }} />
                                            </div>
                                            <div className="content">
                                    ...
                                    <div className="col-lg-6 col-sm-6 mb-6">
                                        <div className="banner-single-item banner-style-2 banner-animation img-responsive"
                                            ...
                                            <div className="image">
                                                <img src="https://cdn.shopify.com/s/files/1/0548/8849/7221/files/Neckbands_400x.png?v=1672254884" alt="" />
                                            </div>
                                            <div className="content">
                                    ...
                                    <div className="col-lg-6 col-sm-6 mb-6">
                                        <div className="banner-single-item banner-style-2 banner-animation img-responsive"
                                            data-aos="fade-up" data-aos-delay="0">
                                            <div className="image">
                                                <img src="https://cdn.shopify.com/s/files/1/0548/8849/7221/files/Speaker_8fbe8a51-5f75-4d8b-a8c4-73f438d2b15e_400x.png?v=1672254907" alt="" />
                                            </div>
                                            <div className="content">
                                    ...
                                    <div className="col-lg-6 col-sm-6 mb-6">
                                        <div className="banner-single-item banner-style-2 banner-animation img-responsive"
                                            data-aos="fade-up" data-aos-delay="200">
                                            <div className="image">
                                                <img src="https://cdn.shopify.com/s/files/1/0548/8849/7221/files/Headphones_f37e59af-124a-485c-90c8-56924506735e_400x.png?v=1672254853" alt="" />
                                            </div>
                                            <div className="content">
                                                {/* <h4>Interior <br/>
                                        lighting</h4>
