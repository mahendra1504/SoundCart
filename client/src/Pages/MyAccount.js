                            ...
                            <div className="dashboard_tab_button" >
                                <ul role="tablist" className="nav flex-column dashboard-list">
                                    ...
                                    {/* <li><a href="#downloads" data-bs-toggle="tab"
                                        className="nav-link btn btn-block btn-md btn-black-default-hover" >Change Password</a>
                                    </li> */}
                                    ...
                                    <div className="row">
                                        <div className="col-12">
                                            <div className="default-form-box">
                                                ...
                                                <input placeholder="Enter Old Password" type="text" onChange={(e) => { setOldPassword(e.target.value) }} />
                                        ...
                                        <div className="col-12">
                                            <div className="default-form-box">
                                                ...
                                                <input placeholder="Enter New Password" type="text" onChange={(e) => { setNewPassword(e.target.value) }} />
                                                <div style={{ color: "red" }}>{newPasswordError}</div>
                                            </div>
                                        </div>
                                        <div className="col-12">
                                            <div className="default-form-box">
                                                <label>Conifrm Password <span>*</span></label>
                                                <input type="text" onChange={(e) => { setConfirmPassword(e.target.value) }} placeholder="Enter Confirm Password" />
                                        ...
                                        <div className="order_button pt-3">
                                            <button className="btn btn-md btn-black-default-hover" type="submit" onClick={(e) => passwordChnageHandler(e)}>Change Password</button>
                                        </div>
                                    </div>
